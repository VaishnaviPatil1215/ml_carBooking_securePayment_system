...
// import { getDynamicPrice } from '@/app/actions';
...
//       toast({
//         variant: 'destructive',
//         title: 'Please select a car first.',
//         description:
//           'You need to choose a vehicle before we can calculate the price.',
//       });
//       return;
//     }
//     setIsAnalyzing(true);
...
//       basePrice,
//       demandFactor: demandFactor[0],
//       seasonalityFactor: seasonalityFactor[0],
...
//   const handleBookNow = () => {
//     if (!selectedCar || !dynamicPrice) {
//       toast({
//         variant: 'destructive',
//         title: 'Incomplete Booking',
//         description: 'Please select a car and analyze the price before booking.',
//       });
//       return;
//     }
...
//       price: dynamicPrice.adjustedPrice.toFixed(2),
//     });

//     router.push(`/confirmation?${params.toString()}`);
//   }

//   const finalPrice = dynamicPrice ? dynamicPrice.adjustedPrice : basePrice;
...
//               <RadioGroup
//                 value={driverOption}
//                 onValueChange={(value: 'driver' | 'self') => setDriverOption(value)}
...
//             </CardTitle>
//             <CardDescription>Adjust factors to see our AI-powered competitive pricing.</CardDescription>
//           </CardHeader>
//           <CardContent className="space-y-4">
//              <div className="space-y-2">
//               <Label>Demand Factor: {demandFactor[0].toFixed(1)}x</Label>
//               <Slider min={0.5} max={2} step={0.1} value={demandFactor} onValueChange={setDemandFactor} />
//             </div>
//              <div className="space-y-2">
//               <Label>Seasonality: {seasonalityFactor[0].toFixed(1)}x</Label>
//               <Slider min={0.5} max={2} step={0.1} value={seasonalityFactor} onValueChange={setSeasonalityFactor} />
//             </div>
//              <div className="space-y-2">
//               <Label>Competitor Price: ${competitorPrice[0]}</Label>
//               <Slider min={50} max={500} step={10} value={competitorPrice} onValueChange={setCompetitorPrice} />
//             </div>
//             <Button onClick={handleAnalyzePrice} disabled={isAnalyzing || !selectedCar} className="w-full bg-accent hover:bg-accent/90 text-accent-foreground">
//               {isAnalyzing ? (
//                 <>
...
//                 ) : dynamicPrice ? (
//                   <div>
//                     <p className="text-sm font-bold text-amber-300">AI-Powered Price:</p>
...
//               </div>
//               <Button onClick={handleBookNow} size="lg" className="w-full sm:w-auto bg-primary-foreground text-primary hover:bg-primary-foreground/90">Book Now</Button>
//             </div>
//         </CardContent>
//       </Card>
//     </div>
